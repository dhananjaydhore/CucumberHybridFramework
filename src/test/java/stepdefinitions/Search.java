...
//		Assert.assertTrue(driver.findElement(By.linkText("HP LP3065")).isDisplayed());
	...
	public void user_enters_invalid_product_into_search_box_field(String invalidProductText) {
		...
		homePage = new HomePage(driver);
		homePage.enterInvalidProductIntoSearchBox(invalidProductText);
//		driver.findElement(By.name("search")).sendKeys(invalidProductText);
	...
	public void user_should_get_a_message_about_no_product_matching() {
		...
		Assert.assertEquals("There is no product that matches the search criteria.", searchResultPage.getNoProductMatchWarningMessage());
